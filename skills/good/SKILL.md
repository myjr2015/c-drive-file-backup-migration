...
- 2026-05-25 公开产品名已改为 `C盘文件备份迁移`，GitHub 英文仓库名使用 `c-drive-file-backup-migration`，公开版本号从内部迭代号重置为 `V0.0.1`。
- 2026-05-25 已生成 Windows 便携版发布包：`release/C盘文件备份迁移-V0.0.1-windows-portable.zip`，包内包含 `C盘文件备份迁移.exe`、`使用说明.txt`、`_internal/assets/app.ico` 和 `_internal/data/schedule.json`；本机 offscreen 启动 exe 5 秒验证可正常运行。
