...
- 2026-05-26 `Ai会话备份 V1.0.0` 发布前已验证本地打包：`python scripts/build_windows_release.py --skip-tests` 生成 `release/Ai会话备份-V1.0.0-windows-portable.zip`，zip 内包含 `Ai会话备份.exe`、`使用说明.txt`、`_internal/assets/app.ico`、`_internal/data/schedule.json`，并用 offscreen 启动 exe 5 秒验证可运行。
